...
# Find a real Tomato Late Blight image from the extracted dataset
img_path = glob.glob(r"C:\Users\nikhi\tensorflow_datasets\downloads\extracted\*\Plant_leave_diseases_dataset_without_augmentation\Tomato___Late_blight\*.JPG")[0]
